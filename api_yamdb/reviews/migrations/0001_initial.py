# Generated by Django 3.2.14 on 2022-07-16 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.DateTimeField(auto_now_add=True, validators=[reviews.validators.validate_year], verbose_name='Дата публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], max_length=16, verbose_name='Роль пользователя')),
